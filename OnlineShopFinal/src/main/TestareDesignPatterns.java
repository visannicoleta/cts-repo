...
public class TestareDesignPatterns {
	...
	public static void main (String [] args) throws PromotieException{
		...
		cos1.calculeazaValoareCos();
		System.out.println("Valoare cos1: "+cos1.getValoareCos());
		Promotie promo = new Promotie(10.0);
		promo.aplicareDiscount(cos1);
